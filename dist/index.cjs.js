...
var GeoFireCollectionRef = /** @class */ (function () {
    ...
    GeoFireCollectionRef.prototype.setStream = function () {
        ...
        this.stream = createStream(this.query || this.ref).pipe(operators.shareReplay(1));
    };
    // GEO QUERIES
    /**
...
function snapToData(id) {
    if (id === void 0) { id = 'id'; }
    return operators.map(function (foo) {
...
function createStream(input) {
    return new rxjs.Observable(function (observer) {
        var unsubscribe = input.onSnapshot(function (value) { return observer.next(value); }, function (error) { return observer.error(error); });
...
exports.GeoFirePoint = GeoFirePoint;
exports.GeoFireCollectionRef = GeoFireCollectionRef;
